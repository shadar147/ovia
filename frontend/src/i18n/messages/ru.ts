...
export const messages: Messages = {
  ...
  "person360.linkDialogSearchDesc": "Поиск непривязанных идентичностей по имени пользователя, email или имени.",
  "person360.identityIdLabel": "ID идентичности",
  "person360.identityIdPlaceholder": "Введите UUID идентичности…",
  "person360.searchIdentityPlaceholder": "Поиск по имени, email…",
  "person360.searchMinChars": "Введите минимум 2 символа для поиска",
  "person360.noOrphansFound": "Непривязанные идентичности не найдены",
  "person360.showingOf": "Показано {count} из {total}",
  "person360.link": "Привязать",
  "person360.linking": "Привязка…",
  "person360.unlinking": "Отвязка…",
  "person360.unlinkConfirmDesc": "Эта идентичность будет отвязана от человека. Её можно привязать снова позже.",
